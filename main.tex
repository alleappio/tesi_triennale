...
\makeatletter
\patchcmd{\noindent}{\ignorespaces}{{\vspace{50pt}}}{}{}
\makeatother

\titleformat{\section}[hang]{\normalfont\LARGE\bfseries}{Capitolo \thesection}{1em}{\vspace{1em}\hrule\vspace{1em}}[\vspace{1em}\hrule\vspace{1em}]
...
\newpage
\input{sections/middleware_di_comunicazione.tex}
%\input{sections/ROS.tex}
%\newpage
%\input{sections/MQTT.tex}
\newpage
\input{sections/scelte_progettuali.tex}
\newpage
